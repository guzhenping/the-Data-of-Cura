...
class aboutWindow(wx.Frame):
	def __init__(self):
		...
		title = wx.StaticText(p, -1, 'Tianjin DaGe Technology Co.Ltd')
		...
		s.Add(wx.StaticText(p, -1, 'About Software:'), flag=wx.TOP, border=10)
		self.addComponent('Company', 'Tianjin DaGe Technology Co.Ltd', 'WebSite', 'http://www.dagekeji.com/')
		self.addComponent('Author', 'guzhenping ', 'WebSite', 'http://blog.csdn.net/guzhenping')
